...
class TransformTool extends Sprite {
	...
	public var controlSize( get, set):Float;
	public var maintainControlForm( get, set):Bool;
	public var moveUnderObjects( get, set):Bool;
	public var toolMatrix( get, set):Matrix;
	public var globalMatrix( get, set):Matrix;
	public var registration( get, set):Point;
	public var currentControl( get, null ):TransformToolControl;
	public var moveEnabled( get, set):Bool;
	public var registrationEnabled( get, set):Bool;
	public var rotationEnabled( get, set):Bool;
	public var scaleEnabled( get, set):Bool;
	public var skewEnabled( get, set):Bool;
	public var outlineEnabled( get, set):Bool;
	public var cursorsEnabled( get, set):Bool;
	public var customControlsEnabled( get, set ):Bool;
	public var customCursorsEnabled( get, set):Bool;
	public var rememberRegistration( get, set):Bool;
	public var constrainScale( get, set):Bool;
	public var constrainRotation( get, set):Bool;
	public var constrainRotationAngle( get, set):Float;
	public var maxScaleX( get, set):Float;
	public var maxScaleY( get, set):Float;
	
	public var boundsTopLeft( get, null ):Point;
	public var boundsTop( get, null ):Point;
	public var boundsTopRight( get, null ):Point;
	public var boundsRight( get, null ):Point;
	public var boundsBottomRight( get, null ):Point;
	public var boundsBottom( get, null ):Point;
	public var boundsBottomLeft( get, null ):Point;
	public var boundsLeft( get, null ):Point;
	public var boundsCenter( get, null ):Point;
	public var mouse( get, null ):Point;
	
	public var moveControl( get, null ):TransformToolControl;
	public var registrationControl( get, null ):TransformToolControl;
	public var outlineControl( get, null ):TransformToolControl;
	public var scaleTopLeftControl( get, null ):TransformToolControl;
	public var scaleTopControl( get, null ):TransformToolControl;
	public var scaleTopRightControl( get, null ):TransformToolControl;
	public var scaleRightControl( get, null ):TransformToolControl;
	public var scaleBottomRightControl( get, null ):TransformToolControl;
	public var scaleBottomControl( get, null ):TransformToolControl;
	public var scaleBottomLeftControl( get, null ):TransformToolControl;
	public var scaleLeftControl( get, null ):TransformToolControl;
	public var rotationTopLeftControl( get, null ):TransformToolControl;
	public var rotationTopRightControl( get, null ):TransformToolControl;
	public var rotationBottomRightControl( get, null ):TransformToolControl;
	public var rotationBottomLeftControl( get, null ):TransformToolControl;
	public var skewTopControl( get, null ):TransformToolControl;
	public var skewRightControl( get, null ):TransformToolControl;
	public var skewBottomControl( get, null ):TransformToolControl;
	public var skewLeftControl( get, null ):TransformToolControl;
	
	public var moveCursor( get, null ):TransformToolCursor;
	public var registrationCursor( get, null ):TransformToolCursor;
	public var rotationCursor( get, null ):TransformToolCursor;
	public var scaleCursor( get, null ):TransformToolCursor;
	public var skewCursor( get, null ):TransformToolCursor;
	...
	public function set_target(d:DisplayObject):DisplayObject {
		...
		if ( d == null ) {
			...
			|| (Std.isOfType( d, DisplayObjectContainer ) && cast( d, DisplayObjectContainer).contains(this))) {
				return _target;
			}
	...
	private function endInteractionHandler(event:MouseEvent):Void {
		if (event.eventPhase == EventPhase.BUBBLING_PHASE || !Std.isOfType(event.currentTarget, Stage)) {
...
class TransformToolMoveShape extends TransformToolInternalControl {
	...
	override public function draw(event:Event = null):Void {
		...
		if (moveUnderObjects) {
			...
			relatedObject = cast( _transformTool.target, DisplayObjectContainer );
		}
...
class TransformToolScaleCursor extends TransformToolInternalCursor {
	...
	override public function updateVisible(event:Event = null):Void {
		...
		if (event != null && Std.isOfType( event.target, TransformToolScaleControl ) ) {
...
class TransformToolSkewCursor extends TransformToolInternalCursor {
	...
	override public function updateVisible(event:Event = null):Void {
		super.updateVisible(event);
		if (event != null && Std.isOfType( event.target, TransformToolSkewBar )) {
